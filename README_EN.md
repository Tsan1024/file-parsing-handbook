...
- [Common Patterns](common-patterns/) - Reusable patterns like error handling, memory optimization
- [Examples](examples/) - Real-world examples like invoice parsing, resume parsing, etc.
...
Contributions are welcome! See [Contributing Guide](.github/CONTRIBUTING.md) for details.
